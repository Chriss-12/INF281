    ...
    <body>
        <div class="container mt-5">
            <form action="me_update.php" method="POST">
                ...
                <input type="text" class="form-control mb-3" name="id_usuarioExpositor" placeholder="id_usuarioExpositor" value="<?php echo $row['id_usuarioExpositor']?>">
                <input type="text" class="form-control mb-3" name="id_usuarioAdministrador" placeholder="id_usuarioAdministrador" value="<?php echo $row['id_usuarioAdministrador']?>">
                <input type="text" class="form-control mb-3" name="cupos" placeholder="cupos" value="<?php echo $row['cupos']  ?>">
                <input type="text" class="form-control mb-3" name="carga_horaria" placeholder="carga_horaria" value="<?php echo $row['carga_horaria'] ?>">
