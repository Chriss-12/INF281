...
if(isset($_POST['enviar'])){
    ...
    if($envio){
        echo "Hola";
        $conexion=query("insert into usuario (nombre, apellido, email, password, confirmado,codigo) 
        values ('$nombre','$apellido','$email','$password','no','$codigo')")or die($conexion->error);
